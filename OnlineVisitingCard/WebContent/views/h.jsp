    ...
    <div class="front-side">
        ...
        <div class="info-grid">
            ...
            <div class="addr">
                ...
                <p>1/2 Street,
                    <strong> ${carddetails.address}</strong>
                    <strong></strong>
                </p>
            </div>
            <div class="phoneNo">
            ...
            <div class="emailId">
                ...
                <p class="email"><strong>${carddetails.email}</strong></p>
                <p class="web">
                    
                    <strong>${carddetails.website}</strong>
                </p>
            </div>
        </div>
    </div>
